...
@Component({
  selector: 'app-telenoreditcampaign',
  templateUrl: './telenoreditcampaign.component.html',
  styleUrls: ['./telenoreditcampaign.component.css']
})
export class TelenoreditcampaignComponent implements OnInit {
  ...
  inputcontenttxt:string="This is a test message from Winter Sale Campaign.";
